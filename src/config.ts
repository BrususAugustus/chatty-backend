...
class Config {
  ...
  private readonly DEFAULT_JWT_TOKEN = 'thisIsSpaToken';
  private readonly DEFAULT_NODE_ENV = 'development';
  private readonly DEFAULT_SECRET_KEY_ONE = 'thisisasecretcookiekey1';
  private readonly DEFAULT_SECRET_KEY_TWO = 'thisisasecretcookiekey2';
